...
print(stats.norm.cdf(-0.02, loc=glaxo_df.gain.mean(), scale=glaxo_df.gain.std()))
print("Probability of making 2% loss or higher in BEML: ")
print(stats.norm.cdf(-0.02, loc=beml_df.gain.mean(), scale=beml_df.gain.std()))
print("Probability of making 2% gain or higher in Glaxo: ")
print(1-stats.norm.cdf(0.02, loc=glaxo_df.gain.mean(), scale=glaxo_df.gain.std()))
print("Probability of making 2% gain or higher in BEML: ")
print(1-stats.norm.cdf(0.02, loc=beml_df.gain.mean(), scale=beml_df.gain.std()))
